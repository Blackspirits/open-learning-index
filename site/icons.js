(() => {
  const paths = {
    brand: '<path d="M3.5 7.5c3.2 0 5.8.8 8.5 2.9v8.1c-2.7-2-5.3-2.8-8.5-2.8Z"/><path d="M20.5 7.5c-3.2 0-5.8.8-8.5 2.9v8.1c2.7-2 5.3-2.8 8.5-2.8Z"/><path d="M12 10.4v8.1"/><path d="m12 2.5.8 1.8 1.8.8-1.8.8-.8 1.8-.8-1.8-1.8-.8 1.8-.8Z"/>',
