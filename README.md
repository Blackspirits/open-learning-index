...
**Status:** v0.4 — Phase 4 head-to-head admission is in progress. **199 / 199 current `advance` candidates have Deep Review evidence.** Phase 4 now records **16 decisions: 6 admit / 10 do_not_admit**. Computer Science & Software is complete at **13 / 13** current advances decided, and the canonical set contains **23 approved/reference courses**. Current shallow state remains **199 advance / 9 hold / 82 reject**.
