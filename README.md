...
**Status:** v0.2 — targeted discovery + shallow screening. **286 discovery candidates + 17 reference fixtures = 303 researched learning experiences.** **102 candidates have now been shallow-screened** across four tranches; current reference records are calibration fixtures, not the final Top 100.
...
- [`docs/screening/shallow-04.md`](docs/screening/shallow-04.md) — practice-focused arts, languages and communication screening tranche.
