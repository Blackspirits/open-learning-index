...
**Status:** v0.4 — Phase 4 head-to-head admission is in progress. **199 / 199 current `advance` candidates have Deep Review evidence.** Phase 4 now records **23 decisions: 9 admit / 14 do_not_admit**. Computer Science & Software and Marketing & Sales are complete in Phase 4, and the canonical set contains **26 approved/reference courses**. Current shallow state remains **199 advance / 9 hold / 82 reject**.
